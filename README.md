...
- [x] Парсинг котировок с API Московской биржи (MOEX) 
...
### 🔑 Этап 2 — Админ-панель
- [ ] Панель управления на SQL Admin       
...
- [ ] Фоновые задачи (scheduler) для парсинга по расписанию  
---
