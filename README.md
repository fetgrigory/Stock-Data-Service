...
После загрузки и нормализации котировок данные передаются в аналитический слой, где выполняется группировка по тикерам и расчёт основных статистических характеристик за выбранный период.
