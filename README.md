...
- 📥 **Экспорт исходных биржевых данных в CSV** данные выгружаются без аналитической агрегации и могут использоваться для самостоятельного анализа, обработки и построения моделей.
...
graph LR
    ...
    D --> E[Детализированные данные]
    E --> F[CSV<br/>для дальнейшего анализа]

    D --> G[Выборка за период]
    G --> H[Аналитический модуль]
    H --> I[XLSX<br/>готовый аналитический отчёт]
```
